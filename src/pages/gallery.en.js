...
import ParralaxVideo from "../images/parralax.mp4"
import KaiserVideo from "../images/kaiser.mp4"
    ...
    <Layout location={props.location}>
      ...
      <Wrapper>
        <div className="column">
          ...
          >
            <video autoPlay loop muted>
              <source src={KarenVideo} type="video/mp4" />
            </video>
          </div>
        ...
        <div className="column">
          ...
          >
            <video autoPlay loop muted>
              <source src={TravisVideo} type="video/mp4" />
            </video>
          </div>
          <div
            className="image-container"
          ...
          >
            <video autoPlay loop muted>
              <source src={ParralaxVideo} type="video/mp4" />
            </video>
          </div>
          <div
            className="image-container"
